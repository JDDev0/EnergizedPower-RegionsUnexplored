package me.jddev0.epbrg.datagen;

import me.jddev0.epbrg.EnergizedPowerModRG;
...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private void buildPlantGrowthChamberRecipes(RecipeOutput output) {
        ...
        addPlantGrowthChamberRecipe(output, Ingredient.of(RuBlocks.CLOVER.get()), new PlantGrowthChamberRecipe.OutputItemStackWithPercentages[] {
                new PlantGrowthChamberRecipe.OutputItemStackWithPercentages(new ItemStack(RuBlocks.CLOVER.get()), new double[] {
                        1., 1., 1., .67, .33, .33, .15
                })
        }, 16000, "clover", "clover");

        addPlantGrowthChamberRecipe(output, Ingredient.of(RuBlocks.ORANGE_CONEFLOWER.get()), new PlantGrowthChamberRecipe.OutputItemStackWithPercentages[] {
        ...
        addPlantGrowthChamberRecipe(output, Ingredient.of(RuBlocks.PURPLE_CONEFLOWER.get()), new PlantGrowthChamberRecipe.OutputItemStackWithPercentages[] {
        ...
        addPlantGrowthChamberRecipe(output, Ingredient.of(RuBlocks.HYACINTH_FLOWERS.get()), new PlantGrowthChamberRecipe.OutputItemStackWithPercentages[] {
        ...
        addPlantGrowthChamberRecipe(output, Ingredient.of(RuBlocks.BLUE_MAGNOLIA_FLOWERS.get()), new PlantGrowthChamberRecipe.OutputItemStackWithPercentages[] {
        ...
        addPlantGrowthChamberRecipe(output, Ingredient.of(RuBlocks.PINK_MAGNOLIA_FLOWERS.get()), new PlantGrowthChamberRecipe.OutputItemStackWithPercentages[] {
        ...
        addPlantGrowthChamberRecipe(output, Ingredient.of(RuBlocks.WHITE_MAGNOLIA_FLOWERS.get()), new PlantGrowthChamberRecipe.OutputItemStackWithPercentages[] {
        ...
        addPlantGrowthChamberRecipe(output, Ingredient.of(RuItems.SALMONBERRY.get()), new PlantGrowthChamberRecipe.OutputItemStackWithPercentages[] {
    ...
    private void addCrusherRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStack output, String recipeIngredientName) {
        ResourceLocation recipeId = ResourceLocation.fromNamespaceAndPath(EnergizedPowerModRG.MODID, PATH_PREFIX + "crusher/" +
    ...
    private void addSawmillRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStack output,
        ...
        ResourceLocation recipeId = ResourceLocation.fromNamespaceAndPath(EnergizedPowerModRG.MODID, PATH_PREFIX + "sawmill/" +
    ...
    private void addPlantGrowthChamberRecipe(RecipeOutput recipeOutput, Ingredient input,
        ...
        ResourceLocation recipeId = ResourceLocation.fromNamespaceAndPath(EnergizedPowerModRG.MODID, PATH_PREFIX + "growing/" +
